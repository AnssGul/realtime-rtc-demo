...
let createAnswer = async () => {
    ...
    // Parse the SDP offer from the textarea
    let offer = document.getElementById('offer-sdp').value;
    if (!offer) return alert('Retrieve the offer from the peer first...');
...
let addAnswer = async () => {
    ...
    if (!answer) return alert('Retrieve the answer from the peer first...');
